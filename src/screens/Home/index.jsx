            ...
            <ScrollView>
                ...
                <View style={styles.hoteis}>
                    ...
                    <View style={styles.negresco}>
                        <Image source={require('../../../assets/images/hotel-negresco.png')} style={{ width: 20, height: 20, marginTop: 30, marginBottom: 35, width: 350, height: 210, borderRadius: 5, marginLeft: -8 }} />
                    ...
                    <View style={styles.madrid}>
                        <Image source={require('../../../assets/images/eurostar.png')} style={{ width: 20, height: 20, marginTop: 30, marginBottom: 35, width: 350, height: 210, borderRadius: 5, marginLeft: -8 }} />
                    ...
                    <View style={styles.anantara}>
                        <Image source={require('../../../assets/images/anantara_palazzo.png')} style={{ width: 20, height: 20, marginTop: 30, marginBottom: 35, width: 350, height: 210, borderRadius: 5, marginLeft: -8 }} />
