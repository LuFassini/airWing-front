             ...
             <EasyNavegation />
                <View>
                    <View style={styles.borda}>
                        <Text style={styles.titulo2}>Termos e condições</Text>
                    </View>
                    ...
                    <Text style={styles.linha}>     ____________________________________________________</Text>
                    ...
                    <View style={styles.borda2}>
                        <Text style={styles.titulo3}>Ao utilizar os serviços da Air Wing Agência de Viagens, você concorda em cumprir estes termos e condições. Se você tiver alguma dúvida, entre em contato conosco para obter esclarecimentos adicionais.</Text>
                    </View>
